...
/**
 * Burada Mundo'nun tek tek rakiplere karşı planlarını tutuyoruz.
 * NOT: difficulty field'de ASCII kullanıyoruz ("TEHLIKELI"),
 * UI'da bunu 'TEHLİKELİ' diye göstereceğiz.
 */
const MUNDO_MATCHUPS_DATA: {
  ...
  },
  {
    ...
    data: {
      ...
      early_plan: [
        "Mist Maiden'ı (bakire) odakla; ghoul'ları Q ile temizle.",
